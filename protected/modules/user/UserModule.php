...
class UserModule extends CWebModule
{
	 ...
	 * @return hash string.
	 */
	public static function encrypting($string="",$hashed=false) {
                if($hashed)return $string;
	...
	//    return mail($email,base64_encode($subject),$message,$headers);
	}
