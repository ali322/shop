				...
				if ($email&&$activkey) {
			    	...
			    	if(isset($_POST['UserRecoveryForm'])) {
			    		...
			    		if($form->validate()) {
			    			...
			    			$message = UserModule::t("You have requested the password recovery site {site_name}.<a href='{activation_url}' target='_blank'>change password</a>.To receive a new password, go to {activation_url}.",
			    					array(
			    						'{site_name}'=>Yii::app()->name,
